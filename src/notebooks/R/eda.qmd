...
subtitle: "Exploring Heart Disease Diagnosis Using Summary Statistics & Data Visualisation"
author: "Paul Johnson"
date: today
---
...
We can use the `geom_histogram()` function to create histograms. The `fill`  and `position` arguments can be used to split the bars by a particular variable and display them in different colours, as dicussed above.
