...
The NHS-R community is a pretty active community of people that are using R in the NHS. You can find them on the [NHS-R website][NHS-R] and [Slack][NHS-R Slack]. They also have a [Github organisation][NHS-R GitHub] and a [YouTube channel][NHS-R YouTube] which both contain tons of really useful resources.

With regards to Python, the equivalent community is the NHS Python Community for Healthcare (typically shortened to NHS-Pycom). The NHS Python Community also have a [website][NHS-Pycom] and a [Slack channel][NHS-Pycom Slack], and they have a [Github organisation][NHS-Pycom GitHub] and a [YouTube channel][NHS-Pycom YouTube] which are both worth checking out. The NHS Python Community is a little smaller than the NHS-R community, but it is still a very active community, and it is growing quickly, with both communities collaborating regularly to try and spread the growth of both languages in the NHS.
