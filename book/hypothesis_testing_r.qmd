...
If a p-value of 0.01 tells us that our results are pretty surprising given our expectations of what the data would have looked like if it was randomly generated (or if we assume that the null hypothesis is true), what should we make of this? Sometimes this is enough, but there's lots of cases where we should seek to do much more.
...
![](figures/hypothesis_testing_black.png)
